export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx2712351fea904aa5",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0d6b72086b83ce3f05ed3dbdfc2f1851",
  ...
  USERS: [
    {
      ...
      id: "o_ubH5gqnL5gxxbX1b-KLcOxufbU",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "demo1",
      // 所在省份
      province: "陕西",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2002", "date": "06-19"},
        {"type": "节日", "name": "在一起的日子", "year": "2022", "date": "03-13"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "小李", "year": "2002", "date": "09-08"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2022", "date": "03-1*"},
      ],
